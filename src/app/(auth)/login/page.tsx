  ...
  return (
    ...
    >
      <div className="glass-strong overflow-hidden rounded-2xl shadow-2xl shadow-black/50">
        {/* Top glow */}
        <div className="h-px bg-gradient-to-r from-transparent via-vc-red-500/60 to-transparent" />
        ...
        <div className="p-8">
          ...
          <div className="mb-8 text-center">
            <motion.div
              ...
              className="mb-3 inline-flex items-center justify-center rounded-2xl bg-gradient-to-br from-vc-red-500 to-vc-red-600 p-3 shadow-lg shadow-vc-red-500/30"
            >
            ...
            <p className="mt-2 font-body text-sm text-gray-500">
              Sign in to connect with your squad
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="glass group flex items-center gap-3 rounded-xl px-4 py-3 transition-all focus-within:ring-1 focus-within:ring-vc-red-500/50">
                <Mail
                  size={16}
                  className="shrink-0 text-gray-500 transition-colors group-focus-within:text-vc-red-500"
                />
                <input
                  id="email"
                  type="email"
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-xs text-vc-red-400 transition-colors hover:text-vc-red-500"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <motion.button
              ...
              disabled={isLoading}
              className={cn(
                'relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-vc-red-500 to-vc-red-600 py-3 font-display text-sm font-bold uppercase tracking-wider text-white shadow-lg shadow-vc-red-500/25 transition-all hover:shadow-vc-red-500/40',
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link
              href="/signup"
              className="font-medium text-vc-cyan-500 transition-colors hover:text-vc-cyan-400"
            >
              Create one
            </Link>
          </p>
